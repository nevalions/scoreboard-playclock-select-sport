...
const sport_config_t sport_configs[SPORT_COUNT] = {
    ...
    {SPORT_CUSTOM_RESET, 0, "Custom", "Reset behavior", PLAYCLOCK_BEHAVIOR_RESET},
    {SPORT_CUSTOM_PAUSE, 0, "Custom", "Pause behavior", PLAYCLOCK_BEHAVIOR_PAUSE},
    {SPORT_CUSTOM_MIXED, 0, "Custom", "Mixed behavior", PLAYCLOCK_BEHAVIOR_MIXED}
};